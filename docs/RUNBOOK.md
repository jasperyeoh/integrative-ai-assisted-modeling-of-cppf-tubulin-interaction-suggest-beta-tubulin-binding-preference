...
- `${HPC_WORKSPACE}/GITHUB_NAMESPACE/TUB-CPPF/tubulin-cppf-md`
...
- `legacy_templates/`: archived legacy templates (mdp, examples)
...
cp "legacy_templates/common/CPPF.mol2" "revision_exec/input/ligand/CPPF_legacy_template.mol2"
cp "legacy_templates/common/ions.mdp" "revision_exec/input/mdp/ions.mdp"
cp "legacy_templates/alpha_template/em.mdp" "revision_exec/input/mdp/em.mdp"
cp "legacy_templates/alpha_template/nvt.mdp" "revision_exec/input/mdp/nvt.mdp"
cp "legacy_templates/alpha_template/npt.mdp" "revision_exec/input/mdp/npt.mdp"
```
...
```bash
cp "legacy_templates/alpha_template/md.mdp" "revision_exec/input/mdp/md_200ns.mdp"
```
