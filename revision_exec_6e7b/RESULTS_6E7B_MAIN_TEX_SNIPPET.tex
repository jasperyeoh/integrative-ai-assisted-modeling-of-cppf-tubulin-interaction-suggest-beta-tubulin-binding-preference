...
Across all replicates, CPPF remained stably associated with the heterodimer: over the final 50~ns (150--200~ns), the backbone RMSD was $0.295 \pm 0.021$~nm (mean $\pm$ s.d.\ across replicates; per-replicate values 0.270, 0.295, and 0.321~nm) and the minimum CPPF--protein heavy-atom distance was $0.203 \pm 0.011$~nm (per-replicate means 0.209, 0.214, and 0.188~nm).
