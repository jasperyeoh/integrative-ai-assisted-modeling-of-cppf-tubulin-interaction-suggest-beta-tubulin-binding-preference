...
if __name__ == "__main__":
    dock4_input = "${LOCAL_WORKSPACE}peryeoh/Desktop/Research/TUB_CPPF/swissdock/swissdock_tuba1b/tuba1b_cppf_27dec/result.dock4"
    csv_output = "${LOCAL_WORKSPACE}peryeoh/Desktop/Research/TUB_CPPF/swissdock/swissdock_tuba1b/tuba1b_cppf_27dec/atub_pose_data.csv"
