...
def split_swissdock_results(input_file):
    ...
    def write_pose_to_file(lines, cnum, cmem):
        ...
        if not lines:
            return
        out_filename = f"${LOCAL_WORKSPACE}peryeoh/Desktop/Research/TUB_CPPF/swissdock/tub_dimer_cppf/extracted_pdb/num{cnum}mem{cmem}.pdb"
...
if __name__ == "__main__":
    input_filename = "${LOCAL_WORKSPACE}peryeoh/Desktop/Research/TUB_CPPF/swissdock/tub_dimer_cppf/result.dock4"
