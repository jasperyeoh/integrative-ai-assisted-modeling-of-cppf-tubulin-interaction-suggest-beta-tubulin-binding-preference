...
if __name__ == "__main__":
    dock4_input = "${LOCAL_WORKSPACE}peryeoh/Desktop/Research/TUB_CPPF/swissdock/tubb3_dock01/result.dock4"
    csv_output = "${LOCAL_WORKSPACE}peryeoh/Desktop/Research/TUB_CPPF/swissdock/tubb3_dock01/btub_pose_data.csv"
